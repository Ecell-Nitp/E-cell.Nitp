export const eventlist = [
  {
    ...
    details: (
      <p>
        <b>Date</b>: November 16, 2024
        <br /> <b>Venue</b>: Meghnad Saha Hall, NIT Patna Main Campus
        <br />
        <b>The Entrepreneurship Cell (E-Cell) of NIT Patna</b> organized a highly
        successful <b>Business Simulation Workshop</b>, aimed at cultivating
        entrepreneurial skills and innovation among students. The event featured
        <b>Mr. Pratik Deo</b>, Founder of iDigiNxt, as the esteemed guest speaker.
        <br /> <strong>Event Highlights</strong>
        <br /> <b>1. Inauguration and Welcome Address:</b> - The session began with a
        motivational address by Dr. Om Ji Shukla, Professor In-Charge of E-Cell,
        emphasizing the importance of entrepreneurship and E-Cell’s
        ...
        experience was provided using a business simulation software developed
        by NXT Academy, utilized by prestigious institutions like Harvard and
        XLRI. - Students managed a simulated smartphone and camera business by
        adjusting parameters such as size, quality, and pricing, learning how
    ...
    images: [
      "/BusinessSimulation/main.webp",
      "/BusinessSimulation/p1.webp",
      "/BusinessSimulation/p2.webp",
      "/BusinessSimulation/p3.webp",
      "/BusinessSimulation/p5.webp",
      "/BusinessSimulation/p4.webp",
      "/BusinessSimulation/p6.webp",
      "/BusinessSimulation/p7.webp",
      "/BusinessSimulation/p8.webp",
      "/BusinessSimulation/p9.webp",
    ],
  },
  {
    ...
    images: [
      "/Founder-fusion/img1.png",
      "/Founder-fusion/img2.png",
      "/Founder-fusion/img3.png",
      "/Founder-fusion/img4.png",
      "/Founder-fusion/img5.png",
      "/Founder-fusion/img6.png",
    ],
  },
  {
    name: "YOUTH JAM",
    ...
    details: (
      <p>
        ...
        Incubation Centre) - Mr. Pratik Deo (Startup Consultant). - Panel
  ...
  },
  {
    ...
    details: (
      <div>
        ...
        <h4><strong>Event Highlights</strong></h4>
        <p>
          <b>1. Two-Round Format:</b><br />
          The event was structured into two engaging and challenging rounds:
        </p>
        <ul>
          <li>
        ...
        <p>
          <b>3. Learning and Engagement:</b><br />
          - Participants gained a deeper understanding of entrepreneurial concepts through engaging activities.<br />
          - The quiz and Q&A sessions provided a platform to apply theoretical knowledge in practical scenarios.<br />
          - The event fostered a culture of collaboration, learning, and innovation among the participants.
        </p>
        <h4><strong>Conclusion</strong></h4>
        <p>
